...
using GatherChill.Ui.Settings_Info;
...
namespace GatherChill.Ui
{
    internal class MainWindow : Window
    {
        ...
        /// </summary>
        public MainWindow() : base($"Gather & Chill {P.GetType().Assembly.GetName().Version} ###Gather&ChillMainWindow")
        {
        ...
        {
            [WindowSelection.ItemViewer] = new()
            {
                Icon = FontAwesomeIcon.Leaf,
                Label = "Item Viewer",
                Draw = () => Item_Menu.Draw()
            },
            [WindowSelection.Reducables] = new()
            {
                Icon = FontAwesomeIcon.FlaskVial,
                Label = "Reducables",
                Draw = () => ReducableViewer.Draw()
            },
            [WindowSelection.GatherList] = new()
            {
            ...
            [WindowSelection.RouteViewer] = new()
            {
                Icon = FontAwesomeIcon.Landmark,
                Label = "Route Viewer",
                Draw = () => { }
            },
        ...
        {
            const string iconPath = "GatherChill.Resources.Icon.png";
            ...
            var imageSize = new Vector2(pluginIcon.Width, pluginIcon.Height) * 0.75f;
